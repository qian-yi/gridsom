      ...
      <el-card shadow="never" :body-style="{ padding: '0px' }">
        <el-row>
          ...
          <el-col :span="2" style="text-align: center;">
            <img
              v-popover:bigAvatar
              :src="'http://8.210.23.245:1337'+vblog.useBackgroundImage.url"
            ...
            <el-popover
              ...
              trigger="hover"
            >
              <i class="el-icon-star-on"></i>{{ vblog.name }}&emsp;
              <br />
              <i class="el-icon-location"></i>{{ vblog.location }}&emsp;
              <br />
              <img :src="'http://8.210.23.245:1337'+vblog.useBackgroundImage.url" style="width: 200px;height: 200px;" />
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
